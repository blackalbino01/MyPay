...
<footer class="container text-center space-2">
    <!-- Logo -->
    <a class="d-inline-flex align-items-center mb-3" href="/" aria-label="MyPay">
        ...
        <span class="brand brand-primary">MyPay</span>
    </a>
    <!-- End Logo -->
    ...
    <ul class="list-inline list-group-flush list-group-borderless">
        <li class="list-inline-item px-2">
            <a class="list-group-item-action" href="https://twitter.com/HussainMAuwal" target="_blank">Support</a>
        </li>
        <li class="list-inline-item px-2">
    ...
    <!-- Copyright -->
    <p class="small text-muted mb-3">⚡️ A project by <a href="https://twitter.com/HussainMAuwal" target="_blank">Hussaini Muhammad Auwal</a>
        ⚡️</p>
